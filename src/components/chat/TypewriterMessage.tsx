...
const markdownClasses =
  "prose prose-sm dark:prose-invert max-w-none text-foreground break-words whitespace-pre-wrap overflow-hidden " +
  ...
  "[&_code]:bg-secondary [&_code]:px-1 [&_code]:py-0.5 [&_code]:rounded [&_code]:text-xs [&_code]:break-all";
