...
const resources = {
  en: {
    translation: {
      ...
      "onboarding.locationSubtitle": "We'll use this to tailor weather-based outfit suggestions for you.",
  ...
  tr: {
    translation: {
      ...
      "onboarding.locationSubtitle": "Hava durumuna göre kombin önerileri için kullanacağız.",
